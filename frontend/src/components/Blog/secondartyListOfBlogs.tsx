...
export default function SecondaryListOfBlogs() {
    return (
        <>
            <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                ...
                <div className="p-4 pl-0">
                    ...
                    <Link href="/blog/2" className="inline-block py-2 rounded text-green-900 mt-2 ml-auto"> Read more </Link>
                </div>
            </div>
            ...
            <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                ...
                <div className="p-4 pl-0">
                    ...
                    <Link href="/blog/3" className="inline-block py-2 rounded text-green-900 mt-2 ml-auto"> Read more </Link>
                </div>
            </div>
            ...
            <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                ...
                <div className="p-4 pl-0">
                    ...
                    <Link href="/blog/4" className="inline-block py-2 rounded text-green-900 mt-2 ml-auto"> Read more </Link>
                </div>
            </div>
        </>
    )
