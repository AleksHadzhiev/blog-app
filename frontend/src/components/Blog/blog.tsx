                        ...
                        <table className="table-auto">
                            <thead>
                                <tr className="bg-gray-200 dark:bg-gray-800">
                                    <th className="p-4">Developers</th>
                                    <th className="p-4">Contributors</th>
                                    <th className="p-4">Organizations</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className="grid grid-cols-3 border-t border-gray-400">
                                    <td className="flex flex-col justify-center items-center p-4">
                        ...
                        <table className="border-collapse border border-gray-400">
                            ...
                            <tbody>
                                <tr className="border-b border-gray-400">
                                    <td className="border border-gray-400 px-4 py-2">United States</td>
                                    <td className="border border-gray-400 px-4 py-2">April 21, 2021</td>
                                    <td className="border border-gray-400 px-4 py-2"><strong>$2,300</strong></td>
                                </tr>
                                <tr className="border-b border-gray-400">
                                    <td className="border border-gray-400 px-4 py-2">Canada</td>
                                    <td className="border border-gray-400 px-4 py-2">May 31, 2021</td>
                                    <td className="border border-gray-400 px-4 py-2"><strong>$300</strong></td>
                                </tr>
                                <tr className="border-b border-gray-400">
                                    <td className="border border-gray-400 px-4 py-2">United Kingdom</td>
                                    <td className="border border-gray-400 px-4 py-2">June 3, 2021</td>
                                    <td className="border border-gray-400 px-4 py-2"><strong>$2,500</strong></td>
                                </tr>
                                <tr className="border-b border-gray-400">
                                    <td className="border border-gray-400 px-4 py-2">Australia</td>
                                    <td className="border border-gray-400 px-4 py-2">June 23, 2021</td>
                                    <td className="border border-gray-400 px-4 py-2"><strong>$3,543</strong></td>
                                </tr>
                                <tr className="border-b border-gray-400">
                                    <td className="border border-gray-400 px-4 py-2">Germany</td>
                                    <td className="border border-gray-400 px-4 py-2">July 6, 2021</td>
                                    <td className="border border-gray-400 px-4 py-2"><strong>$99</strong></td>
                                </tr>
                                <tr className="border-b border-gray-400">
                                    <td className="border border-gray-400 px-4 py-2">France</td>
                                    <td className="border border-gray-400 px-4 py-2">August 23, 2021</td>
                                    <td className="border border-gray-400 px-4 py-2"><strong>$2,540</strong></td>
                                </tr>
                            </tbody>
                        </table>
